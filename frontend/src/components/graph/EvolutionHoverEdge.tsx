  ...
  return (
    <>
      ...
      <EdgeLabelRenderer>
        ...
        <div
          className="nodrag nopan pointer-events-none rounded-md border border-stone-300/90 bg-[#faf7f2]/95 px-1.5 py-0.5 text-[9px] font-mono font-medium text-stone-700 shadow-sm"
          style={{
            position: "absolute",
        ...
        {hover ? (
          <div
            className="nodrag nopan pointer-events-none max-w-[min(92vw,340px)] rounded-xl border border-amber-200/90 bg-white/98 px-3 py-2 text-left shadow-lg shadow-stone-400/20 ring-1 ring-stone-200/80"
            style={{
              position: "absolute",
          ...
          >
            {reason || at ? (
              <>
                ...
                <p className="mt-1 text-[12px] font-medium leading-snug text-stone-800">
                  {reason || "—"}
                </p>
                {at ? (
                  <p className="mt-2 border-t border-stone-200 pt-2 font-mono text-[10px] text-violet-800">
                    discovered_at: {at}
                  </p>
                ) : null}
              </>
              ...
              <>
                <div className="flex items-center gap-2">
                  <div className="font-mono text-[10px] text-orange-700">{rel}</div>
                  {dsEdge ? (
                    <span className="rounded bg-orange-100 px-1 py-0.5 font-mono text-[9px] text-orange-900 ring-1 ring-orange-200/80">
                      {dsEdge}
                    </span>
                  ) : null}
                </div>
              ...
              <>
                <div className="font-mono text-[10px] text-amber-900/90">
                  {rel}
                </div>
                {metrics.length ? (
                  <p className="mt-1 text-[11px] text-stone-700">
